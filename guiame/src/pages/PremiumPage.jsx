    ...
    <div className="premium-page">
      <div className="premium-box">
        ...
        <div className="feature-box green-box">
          ...
          <button className='bg-[#BCD7F5] border-2 border-[#5787E5] text-gray-900 text-lg font-bold rounded-3xl focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2'>Subir a premium</button>
        </div>
